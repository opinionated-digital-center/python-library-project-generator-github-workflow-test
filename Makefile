...
PACKAGE_DIR=python_library_project_generator_github_workflow_test
...
dev-env-full = -E test -E bdd -E type -E format -E lint -E repl
...
setup-cicd-release-stage-github: setup-release-tools-github
